 ...
 */
    run: async (client, interaction) => {
        ...
        if(!interaction.member.permissions.has(PermissionsBitField.Flags.ManageChannels)) return interaction.reply({content: `Bu komutu kullanamazsın.`, ephemeral: true});
